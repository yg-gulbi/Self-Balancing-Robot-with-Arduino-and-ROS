...
This archive note maps recovered media into GitHub-safe titles and public assets. Original phone or chat-export filenames are intentionally omitted so the repository reads like a curated portfolio instead of a raw staging folder.
...
| Internal electronics view | photo | `media/hardware/robot_open_front.png` | Main physical hardware evidence | Public-safe cropped/selected still |
...
| Short-course and alternate raw clips | video | Not committed | Optional external evidence after privacy review | Keep out of repo unless faces/operators are removed |
| Close-up setup clip | video | Not committed | Optional process evidence after privacy review | Keep out of repo unless it adds clear technical value |
...
| `media/process/wheel_bench_test.jpg` | wheel and electronics bench-test evidence |
...
- The obstacle-course GIF is used as supporting evidence for controlled physical motion around simple obstacles.
