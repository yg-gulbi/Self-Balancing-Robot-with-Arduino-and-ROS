...
Use this archive when you want to see the older Arduino-side path. The default physical controller is [`../../firmware/physical_balance_controller`](../../firmware/physical_balance_controller).
