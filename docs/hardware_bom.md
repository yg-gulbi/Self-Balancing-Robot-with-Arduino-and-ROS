...
| Battery pack | 36V battery pack, likely lithium-ion | The Wiring Diagram and the internal robot photo both support a 36V battery feeding the system | `docs/hardware_power_and_io.md`, `media/diagrams/Wiring Diagram.png`, `media/hardware/robot_open_front.png` |
| Power conversion chain | 36V -> 19V DC-DC converter and 19V -> 5V DC-DC converter | The Wiring Diagram explicitly shows a two-stage conversion chain for compute and control electronics | `docs/hardware_power_and_io.md`, `media/diagrams/Wiring Diagram.png` |
...
| Auxiliary microcontroller | Arduino Mini/Nano-class board | The Wiring Diagram labels a `mini Arduino` on the 5V side, but the exact board variant is not readable from the public photos | `docs/hardware_power_and_io.md`, `media/diagrams/Wiring Diagram.png` |
| Relay / switching board | 5V relay module | The 5V auxiliary branch is explicitly drawn toward a relay/power-relay block | `docs/hardware_power_and_io.md`, `media/diagrams/Wiring Diagram.png` |
...
- [Wiring Diagram](<../media/diagrams/Wiring Diagram.png>): public system-level summary of the robot wiring and control architecture.
