...
| Experiment | Environment | Result | Main file or media | Notes |
| --- | --- | --- | --- | --- |
...
| Orbbec Gemini 330 evaluation | Research / integration planning | Investigated | [`research_and_design_decisions.md`](research_and_design_decisions.md), [`hardware.md`](hardware.md) | Gemini 330 integration informed the sensor-head direction, but physical autonomous depth navigation is not presented as finished |
...
| Real-world ROS SLAM/navigation setup | Integration test | Partial | [`archive/ros_experiments/real_world_integration`](../archive/ros_experiments/real_world_integration) | Setup exists, but I am not presenting it as full autonomous physical navigation |
...
- Use `archive/` when you want the older versions, project history, and raw archive material.
