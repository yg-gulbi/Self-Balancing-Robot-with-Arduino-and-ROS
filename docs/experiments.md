...
| FrSky X8R receiver testing | Real robot | Completed | [`receiver_pwm_test.ino`](../firmware/testers/receiver_pwm_test/receiver_pwm_test.ino), [`rc_to_ros_cmd_vel_bridge.ino`](../firmware/testers/rc_to_ros_cmd_vel_bridge.ino), [`experimental_balance_controller_imu_ros.ino`](../archive/legacy_firmware/experimental_balance_controller_imu_ros.ino) | PWM input handling and command mapping from the Taranis Q X7 / X8R radio pair |
...
| Simulation SLAM | Simulation | Completed | [`balance_robot_workflows`](../ros_ws/src/balance_robot_workflows), [`research_and_design_decisions.md`](research_and_design_decisions.md) | SLAM-related launch composition, informed by ORB-SLAM2 and RTAB-Map research |
...
| PID tuning and auto-tuning | Simulation | Completed | [`balance_robot_control`](../ros_ws/src/balance_robot_control), [`archive/legacy_code/pid_experiments`](../archive/legacy_code/pid_experiments) | Manual and automated tuning experiments |
