...
| FrSky X8R receiver testing | Real robot | Completed | [`rc_to_ros_cmd_vel_bridge.ino`](../firmware/bridges_and_testers/rc_to_ros_cmd_vel_bridge.ino), [`experimental_balance_controller_imu_ros.ino`](../archive/legacy_firmware/experimental_balance_controller_imu_ros.ino) | PWM input handling and command mapping from the Taranis Q X7 / X8R radio pair |
